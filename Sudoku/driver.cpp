...
typedef long int off64_t; // Clang/MinGW, if this causes a problem, you can remove this line
typedef long int off_t;   // Clang/MinGW, if this causes a problem, you can remove this line
#endif
#include <unistd.h>
#include <getopt.h>
#else
